...
class SearchBar:
    def __init__(self, driver: WebDriver):
        ...
        self.origin_input_with_text = "button[data-stid='origin_select-menu-trigger']"
    ...
    def wait_for_search_results(self):
        WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located((By.CSS_SELECTOR, self.search_result)))

    def choose_origin_city(self, destination: str):
        self.driver.find_element(By.CSS_SELECTOR, self.city_origin).click()
        origin_btn_text = self.driver.find_element(By.CSS_SELECTOR, self.origin_input_with_text).text
